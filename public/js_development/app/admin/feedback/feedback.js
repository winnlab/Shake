define(
    [
        'canjs',
        'underscore',
        'app/newPodcasts/feedbackItem',
        'app/newPodcasts/feedbackModel',
        'core/appState',
        'css!app/newPodcasts/css/feedback'
    ],

    function (can, _, FeedbackItem, feedbackModel, appState) {
        ...
        var ViewModel = can.Map.extend({
            ...
            toEntity: function (feedbackItem_id) {
                can.route.attr({
                    entity_id: feedbackItem_id,
                    action: 'set',
                    module: 'feedback'
                });
            }
        ...
        return can.Control.extend({
            ...
            init: function () {
                ...
                viewModel.attr({
                    'feedback': new feedbackModel.List({})
                });
