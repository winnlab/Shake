...
//    }
    ...
    $.fn.uploadFile = function (options) {
        ...
        this.hide();
        this.errorLog = $("<div class='error_log'></div>"); //Writing errors
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for (var i = 0; i < files.length; i++) {
                ...
                var form = $("<form style='display:none; position:absolute;left: 150px;' class='" + obj.formGroup + "' method='" + s.method + "' action='" + s.url + "' enctype='" + s.enctype + "'></form>");
                form.appendTo('body');
                var fileArray = [];
